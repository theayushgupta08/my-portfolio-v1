...
const Hero = () => {
  return (
    ...
    <section className='relative w-full h-screen mx-auto'> {/* for the background image - lines */}
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>I'm a aspiring Software Development <br className='sm:block hidden' />Engineer (SDE) and a Content Creator!</p>
        </div>
      </div>
